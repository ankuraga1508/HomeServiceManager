<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCaregiver.aspx.cs" Inherits="BestDealsMVC.AddCaregiver" %>
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Add a caregiver here">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" id="sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="adminDashboard.html">Active Requests</a></li>
			      <li><a href="">Completed Requests</a></li>
            <li><a href="">Rejected Requests</a></li>
          </ul>
          <ul class="nav nav-sidebar">
	          <li><a href="">Add Service</a></li>
            <li><a href="manageService.html">Manage Service</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Add Caregiver</h1>
