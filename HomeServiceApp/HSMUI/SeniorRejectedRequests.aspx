...
<head>
    ...
    <meta name="description" content="Rejected requests for seniors">
...
<body>
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar" id="sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="#">Rejected Requests<span class="sr-only">(current)</span></a></li>
                </ul>
            </div>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="page-header">Rejected Requests</h1>
    ...
    <script src="/js/seniorRejectedRequests.js"></script>
</body>
</html>
